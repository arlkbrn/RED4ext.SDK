...
{
    static const UniversalRelocFunc<void (*)(void)> func(Detail::Addresses::IRenderProxy_sub_00);
    func();
}

RED4EXT_INLINE void IRenderProxy::sub_08()
{
    static const UniversalRelocFunc<void (*)(IRenderProxy*)> func(Detail::Addresses::IRenderProxy_sub_08);
    func(this);
}

RED4EXT_INLINE uint8_t IRenderProxy::sub_18()
{
    static const UniversalRelocFunc<uint8_t (*)(IRenderProxy*)> func(Detail::Addresses::IRenderProxy_sub_18);
    return func(this);
}
...
{
    static const UniversalRelocFunc<uint32_t (*)(IRenderProxy*)> func(Detail::Addresses::IRenderProxy_sub_58);
    return func(this);
}

RED4EXT_INLINE float IRenderProxy::sub_60()
{
    static const UniversalRelocFunc<float (*)(IRenderProxy*)> func(Detail::Addresses::IRenderProxy_sub_60);
    return func(this);
}
...
{
    static const UniversalRelocFunc<void (*)(IRenderProxy*, void*)> func(Detail::Addresses::IRenderProxy_sub_78);
    func(this, a1);
}
...
RED4EXT_INLINE void IRenderProxy::sub_80(void* a1, void* a2)
{
    ...
    static const UniversalRelocFunc<func_t> func(Detail::Addresses::IRenderProxy_sub_80);
    func(this, a1, a2);
}
...
RED4EXT_INLINE bool IRenderProxy::sub_88(void* a1, void* a2)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::IRenderProxy_sub_88);
    return func(this, a1, a2);
}

RED4EXT_INLINE void IRenderProxy::sub_90(void* a1)
{
    static const UniversalRelocFunc<bool (*)(IRenderProxy*, void*)> func(Detail::Addresses::IRenderProxy_sub_90);
    func(this, a1);
}

RED4EXT_INLINE void IRenderProxy::sub_98(void* a1)
{
    static const UniversalRelocFunc<void (*)(IRenderProxy*, void*)> func(Detail::Addresses::IRenderProxy_sub_98);
    func(this, a1);
}
...
{
    static const UniversalRelocFunc<uint8_t (*)(IRenderProxy*, void*)> func(Detail::Addresses::IRenderProxy_sub_A8);
    return func(this, a1);
}

RED4EXT_INLINE void IRenderProxy::sub_B0(void* a1)
{
    static const UniversalRelocFunc<void (*)(IRenderProxy*, void*)> func(Detail::Addresses::IRenderProxy_sub_B0);
    func(this, a1);
}
