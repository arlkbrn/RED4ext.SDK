                                                             ...
                                                             const char* aName, GroupUpdateCallback&& aCallback)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::UpdateRegistrar_RegisterGroupUpdate);
                                                             ...
                                                             BucketUpdateCallback&& aCallback)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::UpdateRegistrar_RegisterBucketUpdate);
