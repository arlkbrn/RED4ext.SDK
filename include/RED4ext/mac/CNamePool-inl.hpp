...
RED4EXT_INLINE RED4ext::CName RED4ext::CNamePool::Add(const char* aText)
{
    ...
    static UniversalRelocFunc<CName* (*)(CName&, const char*)> func(Detail::Addresses::CNamePool_AddCstr);
    func(result, aText);
    return result;
}
...
RED4EXT_INLINE RED4ext::CName RED4ext::CNamePool::Add(const CString& aText)
{
    ...
    static UniversalRelocFunc<CName* (*)(CName&, const CString&)> func(Detail::Addresses::CNamePool_AddCString);
    func(result, aText);
    return result;
}
...
{
    static UniversalRelocFunc<uint8_t (*)(const CName&, const char*)> func(Detail::Addresses::CNamePool_AddPair);
    func(aName, aText);
}
...
{
    static UniversalRelocFunc<const char* (*)(const CName&)> func(Detail::Addresses::CNamePool_Get);
