...
RED4EXT_INLINE RED4ext::CString::CString(const char* aText, Memory::IAllocator* aAllocator)
    : CString(aAllocator)
{
    static UniversalRelocFunc<CString* (*)(CString*, const char*)> func(Detail::Addresses::CString_ctor_str);
    func(this, aText);
}
...
RED4EXT_INLINE RED4ext::CString::CString(const char* aText, uint32_t aLength, Memory::IAllocator* aAllocator)
    : CString(aAllocator)
{
    static UniversalRelocFunc<CString* (*)(CString*, const char*, uint32_t)> func(Detail::Addresses::CString_ctor_span);
...
RED4EXT_INLINE RED4ext::CString::CString(const CString& aOther)
    : CString()
{
    static UniversalRelocFunc<CString* (*)(CString*, const CString&)> func(Detail::Addresses::CString_copy);
    func(this, aOther);
}

RED4EXT_INLINE RED4ext::CString::~CString()
{
    static UniversalRelocFunc<CString* (*)(CString*)> func(Detail::Addresses::CString_dtor);
    func(this);
}
