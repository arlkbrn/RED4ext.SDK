...
RED4EXT_INLINE void RED4ext::PackageReader::ReadHeader(RED4ext::PackageHeader& aOut)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::BasePackageReader_ReadHeader);
...
RED4EXT_INLINE void RED4ext::ObjectPackageReader::OnReadHeader(uint64_t a1, uint64_t a2)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::ObjectPackageReader_OnReadHeader);
...
RED4EXT_INLINE void RED4ext::ObjectPackageReader::ReadHeader()
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::ObjectPackageReader_ReadHeader);
    ...
    , unk118(nullptr)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::ObjectPackageExtractor_Initialize);
...
RED4EXT_INLINE void RED4ext::ObjectPackageExtractor::ExtractSync()
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::ObjectPackageExtractor_ExtractSync);
...
RED4EXT_INLINE RED4ext::JobHandle RED4ext::ObjectPackageExtractor::ExtractAsync()
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::ObjectPackageExtractor_ExtractAsync);
