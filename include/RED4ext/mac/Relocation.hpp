...
private:
    ...
    static void ShowErrorAndTerminateProcess(std::string_view aMsg, std::uint32_t aLastError,
                                             bool aQueryPluginInfo = true);
    static void ShowErrorAndTerminateProcess(std::string_view aMsg, bool aQueryPluginInfo = true);
};
