...
RED4EXT_INLINE void RED4ext::IScriptable::sub_D8(int64_t a1, int64_t a2)
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::IScriptable_sub_D8);
    func(this, a1, a2);
}
...
RED4EXT_INLINE void RED4ext::IScriptable::DestructValueHolder()
{
    ...
    static UniversalRelocFunc<func_t> func(Detail::Addresses::IScriptable_DestructValueHolder);
    func(this);
}
